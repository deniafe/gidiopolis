...
const Footer = () => {
  ...
  return (
    <footer className="bg-my-primary text-center dark:text-neutral-600 dark:bg-neutral-600 text-white lg:text-left">
      <div className="flex md:px-[16rem] items-center justify-center border-aqua-700 p-6 dark:border-neutral-500 lg:justify-between">
          ...
          <div>
            ...
            <div 
              ...
              <a 
                ...
                data-te-animation="[slide-up_1s_ease-in-out]"
                href="#!" 
                className="mr-4 p-1 dark:text-neutral-600 bg-white rounded-full">
                <Twitter />
              </a>
              <a 
                data-te-animation-init
      ...
      {/* Copyright section */}
      <div className="dark:bg-neutral-200 p-6 text-center bg-my-primary">
